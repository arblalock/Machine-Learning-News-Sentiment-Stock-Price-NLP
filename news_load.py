...
source_save_name = START_DATE+'_'+END_DATE+'_T'+START_TIME[:2]+'-'+END_TIME[:2]+'.csv'
...
all_articles_df = pd.concat([all_articles_df.drop(['source'], axis=1), all_articles_df['source'].apply(pd.Series)], axis=1)
